...
$result=mysqli_fetch_array($doctor, MYSQLI_ASSOC);
...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="index.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
               ...
               <div class="row">
                <div class="col-md-12">
                    <a href="adduser.php" class="btn btn-primary" style="margin-bottom: 5px">Add User</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="updateuser.php" class="btn btn-info" style="margin-bottom: 5px">Update</a>
                                                <a onclick="return confirm('Are You Sure To Delete This Record?')" href="deleteuser.php" class="btn btn-danger">Delete</a>
