        ...
        <div id="page-wrapper" >
            <div id="page-inner">
               ...
               <div class="row">
                <div class="col-md-12">
                    <!-- Patient Tables -->
                    <a href="addpatientDoctor.php" class="btn btn-primary" style="margin-bottom: 5px">Add Record</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="updatePatientDoctor.php" class="btn btn-info" style="margin-bottom: 5px">Update</a>
                                                <a onclick="return confirm('Are You Sure To Delete This Record?')" href="deletePatientDoctor.php" class="btn btn-danger">Delete</a>
